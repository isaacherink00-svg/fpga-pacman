...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports gpio_usb_rst] [get_bd_intf_pins gpio_usb_rst/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports gpio_usb_int] [get_bd_intf_pins gpio_usb_int/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports gpio_usb_keycode_0] [get_bd_intf_pins gpio_usb_keycode/GPIO]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI] [get_bd_intf_pins timer_usb_axi/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI] [get_bd_intf_pins spi_usb/AXI_LITE]
  ...
  connect_bd_net -net gpio_usb_int_ip2intc_irpt [get_bd_pins gpio_usb_int/ip2intc_irpt] [get_bd_pins microblaze_0_xlconcat/In0]
  ...
  connect_bd_net -net spi_usb_ip2intc_irpt [get_bd_pins microblaze_0_xlconcat/In1] [get_bd_pins spi_usb/ip2intc_irpt]
  ...
  connect_bd_net -net timer_usb_axi_interrupt [get_bd_pins microblaze_0_xlconcat/In2] [get_bd_pins timer_usb_axi/interrupt]
  connect_bd_net -net usb_spi_miso_1 [get_bd_ports usb_spi_miso] [get_bd_pins spi_usb/io1_i]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins microblaze_0_axi_intc/intr] [get_bd_pins microblaze_0_xlconcat/dout]
